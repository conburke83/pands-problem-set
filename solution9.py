...
#Creating this within a 'try-except'statement. If the user enters the name of a valid .txt file the embedded program will run, otherwise the except statement will just re-prompt the user to enter a valid filename.
try:
    ...
    with open(userfile,'r') as f:
        ...
        for line in f:
            ...
            if linenumber % 2 == 0:
                print(line)
#Except statement to reprompt the user to enter a valid filename   
except:
    userfile = input("Please enter the name of a txt file: ")
